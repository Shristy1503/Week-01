import java.util.Scanner;
  public class AnagramChecker {
    public static void main(String[] args) {
        ...
        String text1 = input.nextLine().toLowerCase().replaceAll("[^a-zA-Z0-9]", ""); // Sanitize input
        System.out.print("Enter the second text: ");
        String text2 = input.nextLine().toLowerCase().replaceAll("[^a-zA-Z0-9]", ""); // Sanitize input
